 ...
 */
public class EditEmergency extends javax.swing.JFrame {
    static int k = 0;
    static int a = 0;
    static String[][] s = new String[135][4];
    static String[][] s1 = new String[135][4];
    static String[][] Convert = new String[135][4];
    String filePath;
    String path;

    /**
     * Creates new form EditEmergency
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Emergency Information");
...
a = imp();
    ...
    private void Delete_Row_ActionPerformed() {
        String[][] delete = new String[136][4];
